...
const char* OledDisplay::_stateName(const char* type, int state) {
    if (strcmp(type, "DBBlocSignal") == 0) {
        switch (state) { case 1: return "HP0"; case 2: return "HP1"; }
    } else if (strcmp(type, "DBEntrySignal") == 0) {
        switch (state) { case 1: return "HP0"; case 2: return "HP1"; case 3: return "HP2"; }
    } else if (strcmp(type, "DBExitSignal") == 0) {
        switch (state) { case 1: return "HP00"; case 2: return "HP1"; case 3: return "HP2"; case 4: return "HP0+SH1"; }
    } else if (strcmp(type, "TrafficLight3ph") == 0 ||
               strcmp(type, "TrafficLight4ph") == 0) {
        switch (state) { case 0: return "STOP"; case 1: return "GO"; case 2: return "GO"; case 3: return "FLASH"; }
    }
